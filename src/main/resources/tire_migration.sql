-- ============================================================
-- FEROS Tire Management Module Migration
-- Run this manually before starting the application
-- ============================================================

USE feros_db;

-- Physical tire inventory
CREATE TABLE IF NOT EXISTS tires (
  ...
  tire_type ENUM('RADIAL','BIAS','TUBELESS','TUBE_TYPE') NOT NULL,
...
-- One row per tire-on-position stint
CREATE TABLE IF NOT EXISTS vehicle_tire_fittings (
  id BIGINT AUTO_INCREMENT PRIMARY KEY,
  tenant_id BIGINT NOT NULL,
  vehicle_id BIGINT NOT NULL,
  ...
  FOREIGN KEY (position_id) REFERENCES vehicle_tire_positions(id),
  FOREIGN KEY (fitted_by_user_id) REFERENCES users(id),
  FOREIGN KEY (removed_by_user_id) REFERENCES users(id),
  FOREIGN KEY (rotation_log_id) REFERENCES tire_rotation_logs(id)
);

-- One row per tire moved in a rotation
CREATE TABLE IF NOT EXISTS tire_rotation_items (
  id BIGINT AUTO_INCREMENT PRIMARY KEY,
  ...
  FOREIGN KEY (rotation_log_id) REFERENCES tire_rotation_logs(id),
  FOREIGN KEY (tire_id) REFERENCES tires(id),
  FOREIGN KEY (from_position_id) REFERENCES vehicle_tire_positions(id),
  FOREIGN KEY (to_position_id) REFERENCES vehicle_tire_positions(id),
  FOREIGN KEY (old_fitting_id) REFERENCES vehicle_tire_fittings(id),
  FOREIGN KEY (new_fitting_id) REFERENCES vehicle_tire_fittings(id)
);
