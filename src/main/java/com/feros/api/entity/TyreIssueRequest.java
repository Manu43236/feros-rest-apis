...
@Entity
@Table(name = "tyre_requests")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class TyreIssueRequest {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "issued_tyre_id")
    private Tyre issuedTyre;
    ...
    @Builder.Default
    private TyreRequestStatus status = TyreRequestStatus.PENDING;
