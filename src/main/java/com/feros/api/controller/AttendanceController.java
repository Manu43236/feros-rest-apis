...
public class AttendanceController {
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'OFFICE_STAFF', 'SUPERVISOR', 'DRIVER', 'CLEANER', 'SERVICE_MANAGER', 'TECHNICIAN', 'STORE_KEEPER', 'OPERATOR')")
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'OFFICE_STAFF', 'DRIVER', 'CLEANER', 'SUPERVISOR', 'SERVICE_MANAGER', 'TECHNICIAN', 'STORE_KEEPER', 'OPERATOR')")
